...
create index due_date_index
    on order_details (due_date);

create index publication_type_index
    on publication_details (publication_type);
...
create index writer_id_index
    on chapter_details (writer_id);
